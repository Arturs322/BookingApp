...
namespace BookingApp.Application.Services.Implementation
{
    public class DashboardService : IDashboardService
    {
        ...
        {
            var totalBookings = _unitOfWork.Reservation.GetAll(u => u.BookingDate >= DateTime.Now.AddDays(-30) &&
        ...
        {
            var bookingData = _unitOfWork.Reservation.GetAll(u => u.BookingDate >= DateTime.Now.AddDays(-30) &&
        ...
        {
            var totalBookings = _unitOfWork.Reservation.GetAll(u => u.Status != SD.StatusPending
        ...
        public async Task<RadialBarChartDto> GetTotalReservationChartData()
        {
            var totalBookings = _unitOfWork.Reservation.GetAll(u => u.Status != SD.StatusPending
          || u.Status == SD.StatusCancelled);
